...
colors:
  ...
  ink-on-orange-faint: "rgba(8,8,8,0.40)"
  ink-on-orange-border: "rgba(8,8,8,0.20)"
...
typography:
  ...
  label:   { fontFamily: "Space Mono", cqw: 0.72, weight: 500, tracking: "0.14em", upper: true }
  # — display / hero ramp (Arial, lowercase, negative tracking) —
  h3:      { fontFamily: "Unbounded", cqw: 2.8, weight: 700, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "Unbounded", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "Unbounded", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "Unbounded", cqw: 5.5, weight: 700, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Unbounded", cqw: 7.5, weight: 700, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "Unbounded", cqw: 7.5, weight: 700, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "Unbounded", cqw: 10.0, weight: 700, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Unbounded", cqw: 10.5, weight: 700, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "Unbounded", cqw: 13.0, weight: 700, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Fonts** — already set to **Unbounded** (display/hero ramp) / **DM Sans** (reading ramp) / **Space Mono** (label/chrome, mono); ignore any preset font name lingering in prose below.
- **Weights** — the brand fonts ship `{400, 500, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 900) in prose.
- **Colors** — use the frontmatter hex; preset color NAMES in prose (e.g. "cobalt", "cream") mean the remapped brand values. `ink-black` (#080808) is the dark ground, `cream` (#F0ECE4) is light text, `fire-orange` (#F5A623) is the single accent — matching LyriaStudio's own `--bg`/`--tp`/`--amber` tokens.
